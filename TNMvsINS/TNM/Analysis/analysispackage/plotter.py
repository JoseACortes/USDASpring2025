...
def multi_spectrum(df, 
    ...
    for i, col in enumerate(columns):
        axs['B'].plot(si_bins, si_spec[col], label=col, color=colors[i], linestyle=linestyles[i])
        axs['C'].plot(c_bins, c_spec[col], label=col, color=colors[i], linestyle=linestyles[i])
